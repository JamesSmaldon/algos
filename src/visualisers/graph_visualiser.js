define([], function() {
    var GraphVisualiser = function(ctx, width, height) {
        this.width = width;
        this.height = height;
        this.ctx = ctx;
    ...
    GraphVisualiser.prototype.render_node = function(node) {
    ...
    GraphVisualiser.prototype.render_edge = function(edge) {
        this.ctx.beginPath();
    ...
    GraphVisualiser.prototype.render = function(graph) {
